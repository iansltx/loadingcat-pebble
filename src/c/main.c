...
#define SPINNER_X PBL_PLATFORM_SWITCH(PBL_PLATFORM_TYPE_CURRENT, 66, 66, 66, 66, 90, 66, 66)
#define SPINNER_Y PBL_PLATFORM_SWITCH(PBL_PLATFORM_TYPE_CURRENT, 44, 44, 44, 44, 59, 44, 44)
#define SPINNER_BASE_INNER_RADIUS PBL_PLATFORM_SWITCH(PBL_PLATFORM_TYPE_CURRENT, 12, 12, 12, 12, 16, 12, 12)
#define SPINNER_BASE_OUTER_RADIUS PBL_PLATFORM_SWITCH(PBL_PLATFORM_TYPE_CURRENT, 28, 28, 28, 28, 36, 28, 28)
#define SPINNER_MINUTE_INNER_RADIUS PBL_PLATFORM_SWITCH(PBL_PLATFORM_TYPE_CURRENT, 14, 14, 14, 14, 18, 14, 14)
#define SPINNER_MINUTE_OUTER_RADIUS PBL_PLATFORM_SWITCH(PBL_PLATFORM_TYPE_CURRENT, 30, 30, 30, 30, 40, 30, 30)
#define SPINNER_HOUR_INNER_RADIUS PBL_PLATFORM_SWITCH(PBL_PLATFORM_TYPE_CURRENT, 12, 12, 12, 12, 16, 12, 12)
#define SPINNER_HOUR_OUTER_RADIUS PBL_PLATFORM_SWITCH(PBL_PLATFORM_TYPE_CURRENT, 28, 28, 28, 28, 36, 28, 28)
#define SPINNER_CENTER_RADIUS PBL_PLATFORM_SWITCH(PBL_PLATFORM_TYPE_CURRENT, 4, 4, 4, 4, 6, 4, 4)
#define SPINNER_BASE_WIDTH PBL_PLATFORM_SWITCH(PBL_PLATFORM_TYPE_CURRENT, 2, 2, 2, 2, 3, 2, 2)
#define SPINNER_MINUTE_WIDTH PBL_PLATFORM_SWITCH(PBL_PLATFORM_TYPE_CURRENT, 3, 3, 3, 3, 4, 3, 3)
#define SPINNER_HOUR_WIDTH PBL_PLATFORM_SWITCH(PBL_PLATFORM_TYPE_CURRENT, 4, 4, 4, 4, 6, 4, 4)
